...
namespace ProjectPanda.Services
{
    ...
    {
        public bool UseAuthentication => false;  /// <summary>
        ...
        public async Task InitializeAsync()
        {
            ...
            if (UseAuthentication && !string.IsNullOrWhiteSpace(Helpers.Settings.AuthToken) && !string.IsNullOrWhiteSpace(Helpers.Settings.UserId))
            {
                MobileService.CurrentUser = new MobileServiceUser(Helpers.Settings.UserId);
                MobileService.CurrentUser.MobileServiceAuthenticationToken = Helpers.Settings.AuthToken;
            }
